...
namespace FlowSharp
{
    public static class ISingleFlowFlow
    {
        private static ISingleFlow<O> Parse<O>(ISingleFlow<O, ISingleFlow<O>> flow)
        {
            if (flow.IsStopped)
        ...
        public static ISingleFlow<O> Flow<O>(this ISingleFlow<O> flow, Func<ISingleFlow<O, ISingleFlow<O>>> func)
        {
            if (flow.IsStopped)
                return flow;
        ...
        public static ISingleFlow<O> Flow<O>(this ISingleFlow<O> flow, Func<O, ISingleFlow<O, ISingleFlow<O>>> func)
        {
            if (flow.IsStopped)
                return flow;
